...
public class ActivityDesign extends ActionBarActivity {
	...
	String[] allowedDisplayArray = { "Facebook", "LinkedIn", "Twitter", "Google +", "Phone", "About", "Email" };
						...
						gridView.setOnItemClickListener(new OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> parent, final View view, final int position, long id) {
								if (position == infoLink.size() - 1) {
									...
									// actions is defined above, linking to the just-built dialog
									// When the last item in the gridView is clicked, show the dialog
									actions.show();
								} else {
									final EditText input = new EditText(ActivityDesign.this);
									// display existing values for this info item by getting it from the tag of the view
									...
									// Below is the dialog for changing button content or delete button
								    ...
								    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
								        ...
								        public void onClick(DialogInterface dialog, int whichButton) {
											...
											// add the removed option to selection candidate list
					...
					if (e == null) {
						if (object != null) {
							...
							for(int i=0; i< numBtns; i++){
								...
								// Log.d("buttons:" , ((MyTag) view.getTag()).getKey() + "   "+ ((MyTag) view.getTag()).getValue());
		...
		DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				for(int i=0;i<selectionArray.length; i++){
					System.out.println("selectionArray + "+ selectionArray.length + selectionArray[i]);
				}
				
				for(int i=0;i<selectionDisplayArray.length; i++){
					System.out.println("selectionDisplayArray + "+ selectionDisplayArray.length + selectionDisplayArray[i]);
				}
