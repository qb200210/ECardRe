...
public class TypefaceUtil {
  ...
  /**
   * Using reflection to override default typeface NOTICE: DO NOT FORGET TO SET
   * TYPEFACE FOR APP THEME AS DEFAULT TYPEFACE WHICH WILL BE OVERRIDDEN
   * 
   * @param context
   *          to work with assets
  ...
  public static void overrideFont(Context context,
    ...
    try {
      ...
      Log.e("font", "Can not set custom font " + customFontFileNameInAssets
